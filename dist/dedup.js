 ...
 */
function findNewestSibling(projectDir, selfPath) {
    let entries;
    try {
    ...
    for (const name of entries) {
        if (!name.endsWith('-summary.txt') || name === selfBase)
            continue;
 ...
 */
export async function dedupAgainstSiblings(summary, summaryPath) {
